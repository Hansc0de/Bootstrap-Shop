...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<h2 class="cart-alert">Your cart is empty</h2>
			...
			<div class="col-sm-8">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<p>Cart is empty</p>
						<div class="horiz"></div>
						<h1 style="text-align: right; font-weight: 600; text-transform: uppercase; font-size: 48px; color: black;">Rp. 0,00</h1>
						<div class="horiz"></div>
